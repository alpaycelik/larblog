                        ...
                        <div class="x_content">
                            ...
                            <form method="post" id="form" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <label for="resimler" class="control-label col-md-3 col-sm-3 col-xs-12">Yeni Resim Ekle</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea name="icerik" id="icerik" class= "form-control col-md-7 col-xs-12 ckeditor" cols="30" rows="10">{{ $bloglar->icerik }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
