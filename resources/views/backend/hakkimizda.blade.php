                        ...
                        <div class="x_content">
                            <form action="" method="post" id="form" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <label for="icerik" class="control-label col-md-3 col-sm-3 col-xs-12">Açıklama</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea name="icerik" id="icerik" class= "form-control col-md-7 col-xs-12" cols="30" rows="10">{{ $hakkimizda->icerik }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
