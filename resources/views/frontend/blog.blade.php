                    ...
                    <div class="blog-posts">
                                ...
                                <div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
                                    <div>
                                        <div class="img-thumbnail">
                                            <img class="img-responsive" src="/frontend/img/blog/blog-image-3.jpg" alt="">
                                        </div>
                                    </div>
                                    <div>
                                        <div class="img-thumbnail">
                                            <img class="img-responsive" src="/frontend/img/blog/blog-image-2.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <article class="post post-large">
                            <div class="post-image single">
                                <img class="img-thumbnail" src="/frontend/img/blog/blog-image-2.jpg" alt="">
                            </div>
